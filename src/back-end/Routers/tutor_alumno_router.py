...
def post_tutor_alumno(asignacion: AsignacionMultiple, db: Session = Depends(server.get_db)):
    return Tutor_Alumno.post_tutor_alumno(asignacion.tutor_dni, asignacion.alumno_dnis, db)
